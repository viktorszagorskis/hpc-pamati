...
RTU HPC centrs jeb Augstas veiktspējas skaitļošanas centrs (High-Performance Computing Centre) ir RTU Inovāciju prorektora dienesta sastāvā esoša struktūrvienība. 
2024. gada sākumā HPC centra superdatoram ir 3224 kodoli (ieskaitot virtualizācijas infrastruktūru) un 25 terabaiti operatīvā atmiņa. Atsevišķam kodolam ir iespēja pieslēgt līdz 2 TB operatīvās atmiņas. HPC superdatoram ir gan CPU, gan grafiskie paātrinātāji (GPU).
2023. gada beigās superdators ieguva četrus jaunus HPC skaitļošanas mezglus, kuriem ir jaunākās paaudzes AMD Genoa procesori (768 kodoli). 

Vairāk par RTU HPC centru var izlasīt [šeit ...](https://hpc.rtu.lv/rigas-tehniskas-universitates-hpc-centrs/)
