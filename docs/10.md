...
Kopš 20. gadsimta vidus eksperimentālo un teorētisko zinātni ir papildinājusi [**skaitļošanas zinātne**](https://github.com/viktorszagorskis/hpc-pamati/blob/main/docs/13.md) (*computational science*). Skaitļošanas zinātni var definēt kā disciplīnu, kas saistīta ar matemātisko modeļu izstrādi, ieviešanu un izmantošanu, lai analizētu un atrisinātu problēmas, izmantojot datorsimulācijas un skaitlisko analīzi. 
