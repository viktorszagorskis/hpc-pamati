...
[**Eksperimentālās zinātnes**](https://github.com/viktorszagorskis/hpc-pamati/blob/main/docs/11.md) pamatā ir novērojumi un mērījumi. [**Teorētiskā zinātne**](https://github.com/viktorszagorskis/hpc-pamati/blob/main/docs/12.md) izstrādā modeļus, kurus dažkārt sauc par dabas likumiem, kas atbilst vai "izskaidro" mērījumus un labākajā gadījumā prognozē parādības, kas vēl nav novērotas. 
