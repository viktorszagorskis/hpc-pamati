...
[**Eksperimentālās zinātnes**](https://github.com/viktorszagorskis/hpc-pamati/blob/main/docs/11.md) pamatā ir novērojumi un mērījumi. [**Teorētiskā zinātne**](https://githubusercontent.com/viktorszagorskis/hpc-pamati/main/docs/12.md) izstrādā modeļus, kurus dažkārt sauc par dabas likumiem, kas atbilst vai "izskaidro" mērījumus un labākajā gadījumā prognozē parādības, kas vēl nav novērotas. 

Kopš 20. gadsimta vidus eksperimentālo un teorētisko zinātni ir papildinājusi [**skaitļošanas zinātne**](https://githubusercontent.com/viktorszagorskis/hpc-pamati/main/docs/13.md) (*computational science*). Skaitļošanas zinātni var definēt kā disciplīnu, kas saistīta ar matemātisko modeļu izstrādi, ieviešanu un izmantošanu, lai analizētu un atrisinātu problēmas, izmantojot datorsimulācijas un skaitlisko analīzi. 

Šodien, lielo datu laikmetā, mums ir pieejami milzīgi datu apjomi no dažādiem avotiem (eksperimentiem un modelēšanas) praktiski visās zinātņu jomās. Tas ir novedis pie ceturtās zinātnes paradigmas – [**datu zinātnes**](https://githubusercontent.com/viktorszagorskis/hpc-pamati/main/docs/14.md). Tā izmanto lielos datus, ko radījušas pirmās trīs zinātnes paradigmas (eksperiments, teorija un modelēšana). Ir vajadzīgas uzlabotas datu vadītas analīzes metodes, lai analizētu šos datus tādā veidā, kas var palīdzēt iegūt no tiem jēgpilnu informāciju un zināšanas,
