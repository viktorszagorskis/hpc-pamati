---
title: Ar HPC saistīti termini 
---


<!-- # Par terminiem -->

## 1.3.10 Ar HPC saistīti termini zinātnē un tehnikā
...
+ Veseli skaitļi tiek izmantoti, lai datorā attēlotu reālos skaitļus.
```


```spoiler {title: "Pašpārbaudes Jaurājums"}
2. Kura no šīm ir augstākā frekvence?
...
```
   ...
   ```spoiler {title: "Pašpārbaudes Jaurājums"}
3. Izvēlies atbilstošāko mērvienību
