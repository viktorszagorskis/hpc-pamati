...
**d) Aptuvenais skaitļošanas zinātnes projekta izklāsts ir: 1) matemātiskā modelēšana, 2) piemērota algoritma izvēle, 3) efektīva algoritma ieviešana (programmēšana) un 4) iegūtās programmas darbināšana datorā.**
