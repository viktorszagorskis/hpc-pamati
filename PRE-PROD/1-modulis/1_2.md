...
Iesākumā aplūkosim **zinātniskās metodes** un superdatoru lomu tajās.
...
Tomēr mēs varam iegūt priekšstatu par procesiem, lietojot skaitļošanas zinātni.
...
Šodien, lielo datu laikmetā, mums ir pieejami milzīgi datu apjomi no dažādiem avotiem (eksperimentiem un modelēšanas) praktiski visās zinātņu jomās. Tas ir novedis pie ceturtās metodes – **datu zinātnes**. Tā izmanto lielos datus, ko radījušas pirmās trīs zinātniskās metodes (eksperiments, teorija un modelēšana).
...
:include-image: pix/ZinatnesParadigmas.png {title: "Zinātniskās metodes", fit: true, desktopOnly: true }

:include-image: pix/hpc-zinatnes-paradigmas-mob.png {title: "Zinātniskās metodes", fit: true, mobileOnly: true }
