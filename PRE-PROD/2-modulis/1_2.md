...
> **Ko nozīmē FLOP/s**? 
Peldošā komata skaitlis ir reāla skaitļa attēlojums datorā. Ja mēs vienā sekundē veicam vienu aprēķinu, piemēram, divu reālu skaitļu saskaitīšanu `:latex: {src: "2.10 \\cdot 4.30"}`, tad tas ir vienāds ar vienu peldošā komata darbību sekundē (1 FLOP/s).
