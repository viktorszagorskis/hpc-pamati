...
Lai piekļūtu otrās nedēļas testam, dodies uz "MANA VIDE", klikšķinot uz atbilstošo pogu lapas augšējā, labajā stūrī. Sadaļā TESTI un UZDEVUMI izvēlies 2. NEDĒĻA, izlasi noteikumus un klikšķini uz **Sākam 2. nedēļas tests**.
```
Lai veicas! 
