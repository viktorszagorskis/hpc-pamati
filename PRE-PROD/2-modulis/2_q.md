...
Lai piekļūtu nedēļas testam, dodies uz "MANA VIDE", klikšķinot uz atbilstošo pogu lapas augšējā, labajā stūrī. Sadaļā TESTI izvēlies 2. NEDĒĻA, izlasi noteikumus un klikšķini uz **Sākam 2. nedēļas testi**.
```
