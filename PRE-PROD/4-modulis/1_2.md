...
Savu domu izklāstu iesniedz TĒRZĒTAVĀ, jeb SARUNU VIETNĒ, kas atrodas zemāk. Vēlams pārdomas noformēt kā PDF dokumentu, kuru vari eksportēt no Word vai Excel. Tas ir domāts, lai to (a) nejauši nevar izdzēst (Tev noteikti paliks oriģināls). Tāpat (b) - Tev ir jāzina, ka PDF jau 30 gadus ir kā vispasaules standarts noslēguma dokumentiem.  
