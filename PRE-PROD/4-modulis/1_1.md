...
```attention-recommendation {label: ""}
Tavs uzdevums ir izvēlies divas Tevi interesējošas tēmas un iepazīties ar konkrētiem eksperimentiem. Lai to izdarītu, dodies uz "Mana vide" un seko turpmākiem norādījumiem.
```
