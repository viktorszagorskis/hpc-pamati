...
Projektā realizētie eksperimenti šeit ir sadalīti četrās tēmās. Zemāk atradīsiet piemērus par šādām tēmām:  
* vide un enerģija (8 piemēri),  
* veselības aprūpe (8 piemēri),   
* ražošana (8 piemēri),  
* transports un būvniecība (7 piemēri).  

Lūdzu izvēlieties divas jūs interesējošas tēmas un iepazīstieties ar veiktajiem eksperimentiem un HPC lomu tajos. Pēc iepazīšanās ar eksperimentu aprakstiem atbildiet uz diviem pašpārbaudes jautājumiem katrā no izvēlētām tēmām.
