...
```attention-recommendation {label: ""}
Tavs uzdevums ir izvēlies divas Tevi interesējošas tēmas un iepazīsties ar konkrētiem eksperimentiem un HPC lomu tajos. Lai to izdarītu, dodies uz "Mana vide" (klikšķini uz pogas lapas augšējā stūrī) un seko turpmākiem norādījumiem.
```
