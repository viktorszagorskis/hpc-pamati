...
```attention-recommendation {label: ""}
Tavs uzdevums ir izvēlies divas Tevi interesējošas tēmas un iepazīties ar konkrētiem eksperimentiem. Lai to izdarītu, dodies uz "Mana vide" (klikšķini uz pogas lapas augšējā stūrī) un seko turpmākiem norādījumiem.
```
