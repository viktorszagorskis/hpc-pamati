...
```attention-recommendation {label: ""}
Tavs uzdevums ir izvēlies divas Tevi interesējošas tēmas un iepazīties ar konkrētiem eksperimentiem. Lai to izdarītu, dodies uz "MANA VIDE". Lapas kreisajā pusē sadaļā TESTI klikšķini uz 4. NEDĒĻA un izlasi aktivitātes aprakstu.
```
