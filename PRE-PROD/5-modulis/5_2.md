...
```attention-recommendation {label: "Kursa NOSLĒGUMA DISKUSIJAS UZDEVUMAM Tu vari piekļūt dodoties uz pieejamo spedpogu "Mana vide" lapas augšējā labajā stūrī"}
```
