...
:include-image: pix/atrums00.png {anchorId: "puzlab", collapsed: false,  align:"center", scale:0.3, title: "Ātruma uzlabojums no mezglu skaita pieauguma"}
...
:include-image: pix/merog01.png {anchorId: "paradokss", collapsed: false,  align:"center", scale:0.15, title: "Ātruma uzlabojuma paradokss"}
...
Apkoposim galvenos ierobežojošos faktorus, kas neļauj iegūt maksimālu efektu no paralēlās skaitļošanas metožu izmantošanas, un tie ir:
