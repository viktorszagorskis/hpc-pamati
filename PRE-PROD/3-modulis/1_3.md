...
```
 ...
 Pieņemsim, ka mums šis vektors būtu jāsasummē, vai jāsareizina, vai arī kā citādi _jāoperē_ ar citu tikpat garu vektoru.  Attēlā ir parādīta šāda **Operācija**. Piemēram, zaļais vektors tiek saskaitīts (vai reizināts, vai tiek veikta vēl kāda cita darbība) ar zilo vektoru.
