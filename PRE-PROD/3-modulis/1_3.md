...
:include-image:  pix/hpc-pamati-3-3-3-1.png {anchorId: "3-3-3", collapsed: false,  align:"center", scale: 0.25, title: "Instrukciju līmeņa paralelizācija"}
...
```
 ...
 Iedomājieties, ka ir astoņu skaitļu kopa. Inženiermatemātikas valodā tas ir **vektors**, kas  sastāv no astoņiem skaitļiem.  Katrs no šiem astoņiem skaitļiem, kas var būt atšķirīgs viens no otra, pats par sevi tiek saukts par **skalāru** elementu. Skalāram var būt jebkāda vērtība, ko var lietot matemātiskajās operācijās ar citu skalāru elementu (vai arī vektoru, ja vēlaties). Tas īsumā ir viss, kas ir jāzin par _Skalāriem_ un _Vektoriem_ un ar vektoriem saistītām _Operācijām_.
...
Diemžēl vienkāršotie GPU kodoli neļauj risināt daudzveidīgus zinātnes uzdevumus, tāpēc tie ir jāapvieno ar CPU un ar programmatūru jāatrod efektīvākie risinājumi. Redzam, ka specializēto īpašību dēļ, **GPU ir jāapvieno ar CPU**.
