...
:include-image: pix/hpc-datoru-vesture.png {anchorId: "datoru-vesture", collapsed: false,  align:"left", fit: true, title: "Poster - Datoru Vesture", scale: 0.6}
...
# 2.11 Jēdzieni, Termini, Modeļi

### 2.11.1 Datora Modelis

:include-image: pix/hpc-datora-modelis-w.png {anchorId: "datora-modelis", collapsed: false,  align:"left", fit: true, title: "Datora Modelis - LV", desktopOnly: true}
...
### 2.11.2 HPC Klāstera Modelis
- Kas ir HPC klāsteris

:include-image: pix/HPC-KLASTERA-MODELIS.png {title: "HPC klāstera modelis", scale: 0.5, align: "left"}
