...
### 2.11.2 HPC Klastera Modelis no Datu Skatu Punkta
...
### 2.11.3 HPC Klatera Anatomija

:include-image: pix/hpc-cluster-anatomy-en-w.png {title: "HPC klastera Anatomija - EN", fit: true, align: "left",  desktopOnly: false }

:include-image: pix/hpc-cluster-anatomy-lv-w.png {title: "HPC klastera Anatomija - LV", fit: true, align: "left",  desktopOnly: false }
